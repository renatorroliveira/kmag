...
/**
  ...
  */
class KmagApp : public KXmlGuiWindow, public IDockHost
{
  Q_OBJECT
  ...
  public Q_SLOTS:
    ...
    void slotToggleDock(bool checked);
    void slotDockEdgeChanged();
  ...
  private:
    // IDockHost
    QMainWindow *dockMainWindow() override { return this; }
    void setDockToggleChecked(bool checked) override;
    void setDockEdgeChecked(DockingManager::Edge e) override;
    void setDockEdgeActionsEnabled(bool enabled) override;
    void reassertSourceMode() override { slotModeChanged(); }
    void popupDockContextMenu(const QPoint &globalPos) override;
    void addStripActions(QWidget *strip) override;
    void removeStripActions(QWidget *strip) override;
  ...
  KToggleAction *m_dockMode;
  KToggleAction *m_dockEdgeTop, *m_dockEdgeBottom, *m_dockEdgeLeft, *m_dockEdgeRight;
  QActionGroup *m_dockEdgeGroup;
